...
from network.ibrnet import Insertnerf
...
class DefaultAggregationNet(nn.Module):
    ...
    def __init__(self,cfg):
        ...
        self.agg_impl = Insertnerf(dim,n_samples=self.cfg['sample_num'])
    ...
    def forward(self, prj_dict, que_pts, que_dir):
        """
        :param prj_dict
        ...
        outs, weight = self.agg_impl(prj_img_feats, prob_embedding, dir_diff, valid_mask, que_pts, que_dir)
