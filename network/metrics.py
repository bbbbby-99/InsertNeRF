...
class PSNR_SSIM(Loss):
    ...
    def __call__(self, data_pr, data_gt, step, **kwargs):
        ...
        ssim = structural_similarity(rgbs_gt,rgbs_pr,win_size=11,channel_axis=-1,data_range=255)
        outputs={
        ...
        def compute_psnr_prefix(suffix):
            if f'pixel_colors_{suffix}' in data_pr:
                ...
                ssim = structural_similarity(rgbs_gt,rgbs_other,win_size=11,channel_axis=-1,data_range=255)
